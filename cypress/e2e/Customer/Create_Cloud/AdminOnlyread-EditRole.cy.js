describe('Admin Read Only Edit role', () => {
    beforeEach(() => {
        cy.on('uncaught:exception', (err, runnable) => {
            return false
        })
        cy.loginAdminReadOnly()

    })

    context('Unauthorized Admin Read Only edit role', () => {
        it('Action success', () => {
    ...
    context('Authorized Admin Read Only edit role', () => {
        it('Action success', () => {
        ...
        it('Usabilities (Admin Read Only click Cancel button. The system display modal “Are you sure to leave information updating?”.', () => {
        ...
        it('Usabilities (Admin Read Only click Other Actions. The system display modal “Are you sure to leave information updating?”.', () => {
        ...
        it('Usabilities (Admin Read Only click back button. The system display modal “Leave Site ?”.', () => {
